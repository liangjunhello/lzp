...
def build_dataset(set_id, transform, data_root, mode='test',noise=0,n_shot=None, split="all", bongard_anno=False):
    if set_id == 'I':
        ...
        if mode == 'train' and n_shot:
            ...
            testset = build_fewshot_dataset(set_id, os.path.join(data_root, ID_to_DIRNAME[set_id.lower()]), transform, mode=mode,noise=noise)
    elif set_id == 'bongard':
